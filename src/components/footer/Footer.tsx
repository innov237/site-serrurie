        ...
        <div className="container pb-5 d-flex align-items-center justify-content-center">
            <div className="row align-items-end">
                <div className="col-md-6 pb-4">
                    <img src={logo} alt="logo" style={{ width: "200px", borderRadius:"100%" }} className="pt-5 pb-3" />
                ...
                <div className="col-md-3 pb-4">
                    <ul>
                        ...
                        <li className="mt-3">
                            <img src={email} style={{ width: "20px" }} alt="flag" /> Yaoundé, Cameroun - Round poind nlongkak <br/> face hotel fraco
                        </li>
                ...
                <div className="col-md-3 pb-4">
                    <ul>
                        ...
                        <li className="mt-2"> <img src={email} style={{ width: "20px" }} alt="flag" /> (+237) 672 317 791 </li>
                        <li className="mt-2"> <img src={email} style={{ width: "20px" }} alt="flag" /> (+237) 659 466 358</li>
                        <li className="mt-2"> <img src={email} style={{ width: "20px" }} alt="flag" /> contact@ongo237.com</li>
                    </ul>
